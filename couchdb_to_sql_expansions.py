...
class YabrDB(object):
    ...
    def create_tables(self):
        user_data = '''CREATE TABLE IF NOT EXISTS user_data (
            ...
            ENGINE=MyISAM 
            '''
        item_types = '''CREATE TABLE IF NOT EXISTS item_types (
        ...
        item_families = '''CREATE TABLE IF NOT EXISTS item_families (
            ...
            ENGINE=MyISAM'''
        with self.connection.cursor() as cursor:
            for sql in (user_data, item_types, item_data, item_categories, item_mechanics, 
    ...
    def select_item_id(self, game_id):
        ...
        return item_id
    def insert_item_data(self, type_id, game_id, name, description, minplayers, 
                         maxplayers, minplaytime, playingtime, maxplaytime,
                         minage, year, categories, mechanics, designers, 
                         publishers, families):
        sql = '''INSERT INTO item_data (type_id, game_id, name, description, minplayers, 
            maxplayers, minplaytime, playingtime, maxplaytime, minage, year) 
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'''
        with self.connection.cursor() as cursor:
            cursor.execute(sql, (type_id, game_id, name, description, minplayers, 
            maxplayers, minplaytime, playingtime, maxplaytime, minage, year))
        self.connection.commit()
    ...
    def update_item_ratings(self, game_id, average, bayesaverage, median, 
        ...
        try:
            ...
            # than None.
            self.insert_item_data(None, game_id, None, None, None, None, None, None, 
                None, None, None, [], [], [], [], [])
    ...
    for item in item_data['rows']:
        ...
        if item['value'].items():
            ...
            try:                
                ...
                pass                
            mysql.insert_item_data(type_id, game_id, item['value']['name'], item['value']['description'], 
